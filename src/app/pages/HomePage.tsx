...
const translations = {
  ...
  ES: {
    ...
    wordsNormal: ['desorden.', 'aventura.', 'caos.', 'magia.', 'descubrimiento.', 'diversión.', 'chispa.', 'locura.', 'café.', 'inspiración.', 'asombro.'],
    myWork: "mi trabajo",
...
export default function HomePage() {
  ...
  const [dgrAnimKey, setDgrAnimKey] = useState(0);
  ...
  const projectImages: { [key: string]: string } = {
    ...
    'ux-8': 'https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/MAIN-PORT/dgr.gif?raw=true',
  };
