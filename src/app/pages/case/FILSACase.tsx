...
export default function FILSACase() {
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-16">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className={`${visibleSections.has('hero') ? 'scroll-fade-in-up delay-200' : 'opacity-0'}`}>
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    The Coquimbo Region participated in the prestigious Santiago International Book Fair (FILSA) in 2011, 2013, 2014, and 2015, under the funding of the Coquimbo Regional Government and the support of the National Council of Culture and Arts. The goal was to highlight its literary and cultural identity, focusing on the legacy of Gabriela Mistral.
                  </p>
                </div>
                ...
                <div className={`w-full ${visibleSections.has('hero') ? 'scroll-fade-in-up delay-300' : 'opacity-0'}`}>
                  <div className="w-full h-[300px] md:h-[400px] lg:h-[500px]">
                    <iframe
                      src="https://www.youtube.com/embed/FkgO4BcP1TM?autoplay=1&mute=1&loop=1&controls=0&modestbranding=1&showinfo=0&rel=0&iv_load_policy=3&disablekb=1&fs=0&playsinline=1&playlist=FkgO4BcP1TM"
              ...
              <div className={`space-y-10 ${visibleSections.has('overview') ? 'scroll-fade-in-left delay-200' : 'opacity-0'}`}>
                <div>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Create a visually striking presence at FILSA that authentically represents the Coquimbo Region's literary heritage and Gabriela Mistral's legacy, while coordinating programming and design to maximize public engagement.
                  </p>
                </div>
              </div>
              ...
              <div className={`space-y-8 ${visibleSections.has('overview') ? 'scroll-fade-in-right delay-300' : 'opacity-0'}`}>
                <div>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Art Direction & Event Programming
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Ministerio de la Cultura | Editorial Letrarte | Corporación Otro Puerto
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-200' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Led a multidisciplinary team to create a visually striking and meaningful presence
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-300' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Developed the concept of «Mistraliano» to transmit Gabriela Mistral's legacy
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-400' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Organized literary activities, workshops, and presentations showcasing regional authors
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-500' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Ensured harmony across stand design, promotional materials, and event activities
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Represented Coquimbo Region's cultural identity on an international stage
                </p>
              </div>
              ...
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Strengthened the connection with Gabriela Mistral's legacy through immersive design
                </p>
              </div>
              ...
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  High public engagement via workshops and presentations
                </p>
              </div>
              ...
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Positive reception from local and international visitors
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 md:py-20">
          <div className="w-full">
            <div className="w-full h-[300px] md:h-[400px] lg:h-[500px]">
              <iframe
                src="https://www.youtube.com/embed/QN9x0Nr8PYw?autoplay=1&mute=1&loop=1&controls=0&modestbranding=1&showinfo=0&rel=0&iv_load_policy=3&disablekb=1&fs=0&playsinline=1&playlist=QN9x0Nr8PYw"
                className="w-full h-full"
                allow="autoplay; encrypted-media"
                title="FILSA Gallery Video 1"
                style={{ border: 'none', pointerEvents: 'none' }}
              />
            </div>
          </div>
          ...
          <div className="w-full flex flex-col gap-12">
            ...
            <div className="space-y-8">
              <p 
                ...
                style={{ fontVariationSettings: "'wdth' 100" }}
              >
                The participation of the Coquimbo Region in FILSA was a successful fusion of art direction and event programming. It highlighted the region's literary talent and cultural ties to Gabriela Mistral, reinforcing the importance of regional voices in international cultural spaces.
              </p>
              ...
              <p 
                ...
                style={{ fontVariationSettings: "'wdth' 100" }}
              >
                The project offered a platform for local authors, promoting cultural exchange and increasing the visibility of Coquimbo's literary heritage.
              </p>
        ...
        <section className="py-12 md:py-20">
          <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            <div>
              <ArrowButton 
                text="next project"
                onClick={() => navigate(getNextProjectRoute('FILSA'))}
                direction="right"
                svgPaths={svgPathsArrow}
              />
            </div>
