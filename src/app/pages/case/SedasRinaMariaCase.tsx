...
export default function SedasRinaMariaCase() {
  ...
  useEffect(() => {
    const currentRefs = [heroRef, overviewRef, processRef, visualsRef, resultsRef, conclusionRef];
    const currentIds = ['hero', 'overview', 'process', 'visuals', 'results', 'conclusion'];
  ...
  return (
    <div className="bg-white min-h-screen w-full">
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-16">
          ...
          <div className={`w-full flex flex-col gap-12 ${visibleSections.has('hero') ? 'scroll-fade-in-up' : 'opacity-0'}`}>
            <div className="flex flex-col gap-8">
              <div className="py-[30px]">
                ...
                >
                  Lozanía / Sedas Rina María ■ {typedText}
              ...
              <div className={`${visibleSections.has('hero') ? 'scroll-fade-in-up delay-200' : 'opacity-0'}`}>
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Lozanía / Sedas Rina María is a luxury textile brand specializing in high-quality silks, blending tradition with contemporary aesthetics. The brand's identity revolves around the elegance and refinement of its silk products, which are produced using intricate craftsmanship.
                </p>
              </div>
              ...
              <div className={`w-full ${visibleSections.has('hero') ? 'scroll-fade-in-up delay-300' : 'opacity-0'}`}>
                <div className="w-full flex justify-center">
                  <img 
                    src="https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/ITEM-PORT/lozania-1.png?raw=true"
                    alt="Lozanía Branding Image"
              ...
              <div className={`${visibleSections.has('hero') ? 'scroll-fade-in-up delay-400' : 'opacity-0'}`}>
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  The project aimed to create a visual identity that communicated the delicate nature of the fabrics, the artisanal process, and the timeless beauty of the product. Claudia Tardito's art direction led to a clean, sophisticated, and cohesive visual presentation for the brand, integrating modern design with traditional luxury.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className={`border border-black p-8 ${visibleSections.has('process') ? 'scroll-scale-in delay-200' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Conveying the luxury and elegance of silk products while emphasizing craftsmanship. The goal was to merge traditional roots with contemporary, high-end positioning.
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('process') ? 'scroll-scale-in delay-300' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Refined typography, minimalistic elements, and a neutral palette to highlight the natural beauty of silk. The logo and system were designed for versatility.
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('process') ? 'scroll-scale-in delay-400' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    In collaboration with photographer Luis Rojas, images captured the textures, colors, and intricacies of the fabrics. Soft lighting and minimalist compositions evoked timeless luxury.
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('process') ? 'scroll-scale-in delay-500' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Every detail —from tags to labels— was designed to reflect sophistication, elegance, and quality.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Visuals Section */}
        <section className="py-12 md:py-20" ref={visualsRef}>
          <div className={`w-full flex flex-col gap-12 ${visibleSections.has('visuals') ? 'scroll-fade-in-up' : 'opacity-0'}`}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className={`${visibleSections.has('visuals') ? 'scroll-fade-in-left delay-200' : 'opacity-0'}`}>
                <img 
                  src="https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/ITEM-PORT/lozania-2.png?raw=true"
                  alt="Lozanía Packaging"
                  className="w-full h-auto object-contain"
                />
              </div>
              <div className={`${visibleSections.has('visuals') ? 'scroll-fade-in-right delay-300' : 'opacity-0'}`}>
                <img 
                  src="https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/ITEM-PORT/lozania-3.png?raw=true"
                  alt="Lozanía Photography"
                  className="w-full h-auto object-contain"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              <div className={`border border-black p-8 ${visibleSections.has('results') ? 'scroll-scale-in delay-200' : 'opacity-0'}`}>
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  A refined and elegant visual identity that communicated the luxury and craftsmanship of Sedas Rina María
                </p>
              </div>
              ...
              <div className={`border border-black p-8 ${visibleSections.has('results') ? 'scroll-scale-in delay-300' : 'opacity-0'}`}>
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Cohesive brand image across all touchpoints: photography, packaging, and marketing
                </p>
              </div>
              ...
              <div className={`border border-black p-8 ${visibleSections.has('results') ? 'scroll-scale-in delay-400' : 'opacity-0'}`}>
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Positive reception from the target market, appreciating the sophisticated aesthetic
                </p>
              </div>
              ...
              <div className={`border border-black p-8 ${visibleSections.has('results') ? 'scroll-scale-in delay-500' : 'opacity-0'}`}>
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Enhanced positioning in the luxury textile market with greater visibility and recognition
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 md:py-20">
          <div className="w-full">
            <img 
              src="https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/ITEM-PORT/lozania-4.png?raw=true"
              alt="Lozanía Visual Identity"
          ...
          <div className={`w-full flex flex-col gap-12 ${visibleSections.has('conclusion') ? 'scroll-fade-in-up' : 'opacity-0'}`}>
            ...
            <div className="space-y-8">
              <p 
                ...
                style={{ fontVariationSettings: "'wdth' 100" }}
              >
                The Lozanía / Sedas Rina María project successfully merged traditional craftsmanship with modern design to create a visually captivating and cohesive brand identity.
              </p>
              ...
              <p 
                ...
                style={{ fontVariationSettings: "'wdth' 100" }}
              >
                Through thoughtful art direction and collaboration with photographer Luis Rojas, the project highlighted the elegance and luxury of the silk products, solidifying the brand's position in the high-end market. Claudia Tardito's work ensured that every detail was considered, creating a seamless and engaging brand experience.
              </p>
              ...
              <div className="flex flex-col gap-2">
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  📌 More Info: Sedas Rina María | Photography by Luis Rojas | Art Direction by Claudia Tardito
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 md:py-20">
          <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            <div>
              <ArrowButton 
                text="next project"
                onClick={() => navigate(getNextProjectRoute('Sedas Rina María'))}
                direction="right"
                svgPaths={svgPathsArrow}
              />
            </div>
