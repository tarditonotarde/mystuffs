...
export default function TrashtourBCNCase() {
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className={`${visibleSections.has('hero') ? 'scroll-fade-in-up delay-200' : 'opacity-0'}`}>
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Trashtour Magazine offers a unique perspective on urban exploration, allowing readers to discover cities without physically moving. This Barcelona edition uses the L3 Line as the structural backbone to unveil cultural narratives, contemporary art, urban landscapes, and human stories across Catalonia's vibrant capital.
                  </p>
                </div>
                ...
                <div className={`w-full ${visibleSections.has('hero') ? 'scroll-fade-in-up delay-300' : 'opacity-0'}`}>
                  <div className="w-full rounded-lg overflow-hidden">
                    <iframe 
                      ...
                      scrolling="no"
                      src="https://heyzine.com/flip-book/8e3f444548.html"
                      className="w-full border border-gray-300 h-[400px] md:h-[500px] lg:h-[600px]"
                      title="Trashtour BCN Magazine"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-16">
              <div>
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Trashtour's identity thrives on contrasts and eclectic urban storytelling. Features on exhibitions, creative movements, and contemporary art intermingle with neighborhood stories, narratives, and histories from diverse districts across Barcelona's L3 Line.
                </p>
              </div>
        ...
        <section className="py-12 md:py-20" ref={impactRef}>
          <div className={`w-full flex flex-col gap-12 ${visibleSections.has('impact') ? 'scroll-fade-in-up' : 'opacity-0'}`}>
            ...
            <div className={`w-full grid grid-cols-2 gap-4 md:gap-6 ${visibleSections.has('impact') ? 'scroll-fade-in-up delay-300' : 'opacity-0'}`}>
              <ImageWithFallback 
                src="https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/ITEM-PORT/trashtour-9.jpg?raw=true"
                alt="Trashtour BCN - Urban Photography 1"
                className="w-full h-auto object-cover"
              />
              <ImageWithFallback 
                src="https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/ITEM-PORT/trashtour-10.jpg?raw=true"
                alt="Trashtour BCN - Urban Photography 2"
                className="w-full h-auto object-cover"
              />
              <ImageWithFallback 
                src="https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/ITEM-PORT/trashtour-11.jpg?raw=true"
                alt="Trashtour BCN - Urban Photography 3"
                className="w-full h-auto object-cover"
              />
              <ImageWithFallback 
                src="https://github.com/tarditonotarde/IMAGES_REPO/blob/main/public/assets/IMAGES/ITEM-PORT/trashtour-12.jpg?raw=true"
                alt="Trashtour BCN - Urban Photography 4"
                className="w-full h-auto object-cover"
              />
            </div>
          </div>
        ...
        <section className="py-12 md:py-20">
          <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            <div>
              <ArrowButton 
                text="next project"
                onClick={() => navigate(getNextProjectRoute('Trashtour BCN'))}
                direction="right"
                svgPaths={svgPathsArrow}
              />
            </div>
