...
export default function ArcFestivalCase() {
  ...
  useEffect(() => {
    const currentRefs = [heroRef, overviewRef, researchRef, featuresRef, impactRef];
    const currentIds = ['hero', 'overview', 'research', 'features', 'impact'];
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-16">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className={`${visibleSections.has('hero') ? 'scroll-fade-in-up delay-200' : 'opacity-0'}`}>
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    The Festival de las Artes Región de Coquimbo (ARC) is an international arts festival held annually in the Coquimbo Region of Chile. Featuring music, theater, dance, visual arts, and literature, ARC has become the largest festival of its kind in Chile.
                  </p>
                </div>
                ...
                <div className={`w-full ${visibleSections.has('hero') ? 'scroll-fade-in-up delay-300' : 'opacity-0'}`}>
                  <iframe
                    src="https://www.youtube.com/embed/yKeFfaWkc4Y?autoplay=1&mute=1&loop=1&playlist=yKeFfaWkc4Y&controls=1"
                    className="w-full h-[300px] md:h-[400px] lg:h-[500px] border border-black"
                    allow="autoplay; encrypted-media"
                    allowFullScreen
                    title="ARC Festival Video 1"
                  />
                </div>
                ...
                <div className={`${visibleSections.has('hero') ? 'scroll-fade-in-up delay-400' : 'opacity-0'}`}>
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Taking place during the second half of January each year, ARC brings together regional, national, and international artists, making it a platform for the development and promotion of various artistic disciplines.
                  </p>
                  <p 
                    className="font-['Instrument_Sans:Regular',sans-serif] text-[14px] text-black tracking-[-0.42px] leading-relaxed mt-4"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Over five years, Claudia Tardito contributed as the Art Director, responsible for overseeing the design, aesthetic production, and the visual cohesion of the festival's branding and communication materials.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className={`space-y-8 ${visibleSections.has('overview') ? 'scroll-fade-in-right delay-300' : 'opacity-0'}`}>
                <div>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    International Arts Festival Branding & Design
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Festival de las Artes Región de Coquimbo (ARC)
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Art Direction, Design & Aesthetic Production
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-200' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Capturing the vibrancy and diversity of the festival while reflecting the cultural richness of the Coquimbo region
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-300' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    The identity evolved but always emphasized inclusivity and dynamism, blending bold graphics with references to local heritage
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-400' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Posters, flyers, banners, and social media assets using expressive typography, vibrant colors, and imagery of landscapes and artists
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-500' : 'opacity-0'}`}>
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Stage Design & Aesthetics
                  </p>
                  <p 
                    className="font-['Instrument_Sans:Regular',sans-serif] text-[14px] text-black tracking-[-0.42px] mt-3"
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Immersive environments for performances, workshops, and talks, aligned with the festival's themes
                  </p>
                </div>
                ...
                <div className={`border border-black p-8 ${visibleSections.has('research') ? 'scroll-scale-in delay-600' : 'opacity-0'}`}>
                  ...
                  <p 
                    ...
                    style={{ fontVariationSettings: "'wdth' 100" }}
                  >
                    Coordinated with 15 municipalities and organizations to ensure cohesive branding across all venues and activities
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-12 md:py-20">
          <div className="w-full space-y-8">
            <iframe
              src="https://www.youtube.com/embed/e4OADj_x0yo?autoplay=1&mute=1&loop=1&playlist=e4OADj_x0yo&controls=1"
              className="w-full h-[300px] md:h-[400px] lg:h-[500px] border border-black"
              allow="autoplay; encrypted-media"
              allowFullScreen
              title="ARC Festival Video 2"
            />
            <iframe
              src="https://www.youtube.com/embed/ioDfoHe6Rfg?autoplay=1&mute=1&loop=1&playlist=ioDfoHe6Rfg&controls=1"
              className="w-full h-[300px] md:h-[400px] lg:h-[500px] border border-black"
              allow="autoplay; encrypted-media"
              allowFullScreen
              title="ARC Festival Video 3"
            />
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  A cohesive and recognizable brand identity communicating the festival's multidisciplinary nature
                </p>
              </div>
              ...
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Strong community engagement with visually impactful materials
                </p>
              </div>
              ...
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Increased visibility for regional artists and cultural exchange
                </p>
              </div>
              ...
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Growth into Chile's largest arts festival, attracting thousands of attendees worldwide
                </p>
              </div>
              ...
              <div className="border border-black p-8">
                ...
                <p 
                  ...
                  style={{ fontVariationSettings: "'wdth' 100" }}
                >
                  Positive feedback for its inclusive and inspiring visual design
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full flex flex-col gap-12">
            ...
            <div className="space-y-8">
              <p 
                ...
                style={{ fontVariationSettings: "'wdth' 100" }}
              >
                The design and aesthetic production for ARC Festival played a crucial role in its success and growth. Through a carefully developed visual identity and collaborative design efforts, the festival celebrated the richness of local culture while inviting international artistic exchange.
              </p>
              ...
              <p 
                ...
                style={{ fontVariationSettings: "'wdth' 100" }}
              >
                Claudia Tardito's contributions helped position ARC as a key cultural event in Chile, with its own distinctive visual signature that resonated with diverse audiences.
              </p>
              ...
              <div className="flex items-center gap-2">
                ...
                <a 
                  href="https://www.festivalarc.com" 
                  target="_blank" 
        ...
        <section className="py-12 md:py-20">
          <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            <div>
              <ArrowButton 
                text="next project"
                onClick={() => navigate(getNextProjectRoute('Arc Festival'))}
                direction="right"
                svgPaths={svgPathsArrow}
              />
            </div>
